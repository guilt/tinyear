...
Tests use a generated 16 kHz formant tone so they run offline. Optional real speech: `python scripts/fetch_speech.py` prints how to pull LibriSpeech dev-clean from OpenSLR.
